...
<!--                 <a class="navbar-brand" href="#page-top">PubHub</a> -->
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
                        <a tabindex="-1" href="animalCareHome" class="dropdown-toggle" data-toggle="dropdown">Animal Care<b class="caret"></b></a>
                        <ul class="dropdown-menu">
                          <li><a href="animalCareHome">Home (Level 100)</a></li>
                          <li class="divider"></li>
                          <li><a href="addAnimal">Add Animal</a></li>
                          <li><a href="addFeedingSchedule"> Add Feeding Schedule</a></li>
                          <li><a href="removeFeedingschedule">Remove Feeding Schedule</a></li>
